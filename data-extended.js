...
<br>🚌 免費接駁車 — JR別府站西口（約15分鐘/班）・免費戶外停車場`,
    ...
    {
        day: 7, date: "6/17(三)", title: "最後採買與返程", area: "博多站・天神",
        hotel: "溫暖的家", hotelLat: 0, hotelLng: 0, center: [33.59, 130.42],
        hotelImage: "",
        hotelDesc: "【星宇航空 JX841】福岡14:15発→台北15:45着<br>🚌 HEARTS エアポートバス 福岡市役所前→空港国際線",
        transport: { public: "【🚌 HEARTS エアポートバス】天神 福岡市役所前 → 福岡空港国際線<br>• 運賃：片道 ¥600（現金のみ、上車向車掌購買）<br>• 所要：約25分（経由博多）<br>• 不用預約，直接在福岡市役所前巴士站等<br>• 6/17(水) 可用班次：H008 09:40 / H010 10:40 / H012 11:30 / H014 12:30…<br>• 福岡市役所前バス停：Il Palazzo 徒步10分（過春吉橋直走）<br><br>【備案】西鉄直行バス 博多駅筑紫口→国際線 ¥310・18分・每15分/班・不用預約" },
        timeline: [
            { time: "09:00", act: "Il Palazzo 退房", desc: "步行至福岡市役所前約10分" },
            { time: "10:40", act: "HEARTS 巴士 天神発→空港", desc: "H010 福岡市役所前10:40発→国際線11:25着" },
            { time: "11:30", act: "機場免税店 / ラーメン滑走路", desc: "最後採買伴手禮、午餐" },
            { time: "13:00", act: "辦理登機手續", desc: "JX841 14:15発 往台北" },
