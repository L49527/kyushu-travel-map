...
const weather = [
    { date: '06/11', dow: '四', icon: '🌤️', high: 27, low: 21, rain: 20, gear: '建議攜帶折傘', clothing: '短袖+薄休閒褲' },
    { date: '06/12', dow: '五', icon: '⛅', high: 28, low: 22, rain: 30, gear: '備用折傘', clothing: '透氣排汗衣物' },
    { date: '06/13', dow: '六', icon: '🌧️', high: 26, low: 21, rain: 60, gear: '務必帶大傘/雨衣', clothing: '防潑水外套+薄長褲' },
    { date: '06/14', dow: '日', icon: '🌦️', high: 25, low: 20, rain: 50, gear: '務必帶大傘', clothing: '短袖+薄外套' },
    { date: '06/15', dow: '一', icon: '⛅', high: 26, low: 20, rain: 35, gear: '建議帶折傘', clothing: '短袖+薄外套(阿蘇較涼)' },
    { date: '06/16', dow: '二', icon: '🌤️', high: 28, low: 22, rain: 25, gear: '遮陽傘/防曬', clothing: '短袖涼感衣' },
    { date: '06/17', dow: '三', icon: '☀️', high: 29, low: 23, rain: 15, gear: '防曬/墨鏡', clothing: '夏日輕便服裝' }
];
...
const data = [
    {
        ...
        shopping: [
            ...
            { name: "Aesop / LUSH 博多", hours: "10:00-21:00", desc: "位於博多 AMU PLAZA，香氛與美妝必逛", tag: "香氛", lat: 33.5897, lng: 130.4207 },
            { name: "Ball & Chain (COELACANTH)", hours: "10:00-20:00", desc: "博多站專門店，超人氣刺繡環保購物袋", tag: "設計", lat: 33.5900, lng: 130.4215 },
            { name: "川久保玲 (CDG) 博多店", hours: "11:00-20:00", desc: "JR 博多站旁的獨立面店，潮流玩家聖地", tag: "潮流", lat: 33.5890, lng: 130.4220 }
        ],
        specialties: [
            ...
            { name: "博多織精品", hours: "10:00-20:00", desc: "傳統工藝織品，質感極佳", tag: "工藝", lat: 33.5897, lng: 130.4207, image: "images/博多織精品", mapUrl: "https://www.google.com/maps/search/?api=1&query=サヌイ織物+博多駅" },
            { name: "一蘭經典拉麵包", hours: "24H", desc: "在家也能還原豚骨湯頭", tag: "拉麵", lat: 33.5905, lng: 130.4185, image: "images/一蘭經典拉麵包.jpg", mapUrl: "https://www.google.com/maps/search/?api=1&query=一蘭+博多駅" },
    ...
    },
    {
        ...
        shopping: [
            ...
            { name: "岩田屋本店 (CDG/三宅一生)", hours: "10:00-20:00", desc: "高端品牌齊聚，CDG 與 Issey Miyake 必逛", tag: "百貨", lat: 33.5895, lng: 130.3988 },
            { name: "高山質店 (天神店)", hours: "10:00-19:00", desc: "福岡最強二手精品店，Chanel 包款狀態極佳", tag: "二手", lat: 33.5880, lng: 130.3960 },
            { name: "KOMEHYO (米兵) 天神店", hours: "10:30-19:30", desc: "日本最大連鎖二手店，Chanel 鑑定最專業", tag: "二手", lat: 33.5890, lng: 130.3970 },
            { name: "天神地下街 (Sanrio/clear)", hours: "10:00-20:00", desc: "歐風設計中找尋三麗鷗與日系女裝", tag: "商圈", lat: 33.5902, lng: 130.3985 },
            { name: "福岡 PARCO (Disney/PORTER)", hours: "10:00-20:30", desc: "4F COLLECTORS 有 PORTER 專櫃，款式年輕", tag: "商場", lat: 33.5895, lng: 130.3978 },
            { name: "LOFT 天神店", hours: "10:00-21:00", desc: "PORTER 基礎款與經典尼龍包款，順路好逛", tag: "雜貨", lat: 33.5898, lng: 130.3992, mapUrl: "https://www.google.com/maps/search/?api=1&query=ロフト+天神店" },
            { name: "2nd STREET 天神", hours: "11:00-21:00", desc: "二手 PORTER 約全新 5-7 折，可挖停產款與特別色", tag: "二手", lat: 33.5878, lng: 130.3948, mapUrl: "https://www.google.com/maps/search/?api=1&query=セカンドストリート+天神店" },
            { name: "RAGTAG 天神店", hours: "11:00-20:00", desc: "高級二手服飾精品，品質鑑定嚴格，設計師品牌齊全", tag: "二手", lat: 33.5882, lng: 130.3940, mapUrl: "https://www.google.com/maps/search/?api=1&query=RAGTAG+福岡天神店" }
        ],
        specialties: [
            { name: "鋼彈基地限定模型", hours: "10:00-21:00", desc: "LaLaport 獨家販售商品", tag: "模型", lat: 33.5665, lng: 130.4283, image: "images/鋼彈基地限定模型.webp", mapUrl: "https://www.google.com/maps/search/?api=1&query=Gundam+Side-F+Fukuoka" },
            { name: "天神地下街精品", hours: "10:00-20:00", desc: "各式高質感日系選品", tag: "精品", lat: 33.5902, lng: 130.3985, image: "images/天神地下街精品.webp", mapUrl: "https://www.google.com/maps/search/?api=1&query=天神地下街" },
            { name: "一蘭拉麵泡麵禮盒", hours: "10:00-23:00", desc: "天神店限定包裝", tag: "伴手禮", lat: 33.5905, lng: 130.3985, image: "images/一蘭經典拉麵包.jpg", mapUrl: "https://www.google.com/maps/search/?api=1&query=一蘭+天神店" },
            { name: "福岡八女茶", hours: "09:00-20:00", desc: "福岡代表性茗茶", tag: "茶葉", lat: 33.5898, lng: 130.4210, image: "images/福岡八女茶.webp", mapUrl: "https://www.google.com/maps/search/?api=1&query=八女茶+福岡" }
        ],
        supermarkets: [
            { name: "Reganet Cute 博多巴士總站", hours: "07:00-23:00", desc: "位於B1，距離飯店步行約 3 分鐘", tag: "便利", lat: 33.5915, lng: 130.4205 },
            { name: "Lopia 博多 Yodobashi", hours: "10:00-20:00", desc: "高CP值生鮮超市，距離飯店步行約 2 分鐘", tag: "便宜", lat: 33.5885, lng: 130.4225 },
