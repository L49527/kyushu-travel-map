...
const data = [
    {
        ...
        specialties: [
            ...
            { name: "明太子禮盒 (やまや)", hours: "09:00-21:00", desc: "福岡名產熟成明太子，經過168小時熟成，口感圓潤且層次豐富。不管是拌飯或作為下酒菜都非常合適，是博多最具代表性的海鮮伴手禮。", tag: "海鮮", lat: 33.5898, lng: 130.4206, image: "images/明太子禮盒 (やまや).jpg", mapUrl: "https://www.google.com/maps/search/?api=1&query=やまや+博多デイトス店" },
            {
                name: "茅乃舍高湯包",
                hours: "10:00-20:00",
                desc: "主理人推薦湯包😍，使用國產食材且不添加化學調味。除了極品高湯（あごだし），還有博多限定口味！【補充推薦】影片熱推的「茶碗蒸料理包」與「即食蔬菜湯塊」，只需熱水沖泡即可享用如料亭般的精緻風味🍲。",
                tag: "調料",
                igRecommend: true,
                lat: 33.5902,
                lng: 130.4207,
    ...
    },
    {
        ...
        meals: {
            ...
            lunch: [
                { name: "麺屋兼虎 天神本店", hours: "10:30-23:00", desc: "天神午餐排隊名店首選。濃厚魚介沾麵、Q 彈中太麵，官方也主打「行列ができるつけ麺店」。想吃重口味拉麵就排這間", tag: "排隊拉麵", igRecommend: true, threadRecommend: true, lat: 33.5890, lng: 130.3985, mapUrl: "https://www.google.com/maps/search/?api=1&query=麺屋兼虎+天神本店" },
                { name: "博多らーめん Shin-Shin 天神本店", hours: "11:00-03:00", desc: "天神人氣豚骨拉麵代表，湯頭清爽但香氣足。中午常排隊，適合想吃福岡經典拉麵又不想太厚重的人", tag: "排隊拉麵", igRecommend: true, lat: 33.5908, lng: 130.4015, mapUrl: "https://www.google.com/maps/search/?api=1&query=博多らーめん+ShinShin+天神本店" },
                { name: "ひょうたん寿司", hours: "11:30-21:30", desc: "天神知名壽司午餐，靠近 Solaria Stage。價格相對親切、翻桌快，但尖峰時間常排隊，想吃海鮮就選這間", tag: "排隊壽司", igRecommend: true, lat: 33.5904, lng: 130.3989, mapUrl: "https://www.google.com/maps/search/?api=1&query=ひょうたん寿司+天神" },
                { name: "極味や 福岡パルコ店", hours: "11:00-22:00", desc: "天神 PARCO 人氣漢堡排，自己在小鐵板上烤到喜歡熟度。肉汁感很強，想吃肉的排隊午餐就選它", tag: "排隊肉食", igRecommend: true, lat: 33.5901, lng: 130.3984, mapUrl: "https://www.google.com/maps/search/?api=1&query=極味や+福岡パルコ店" },
                { name: "元祖博多めんたい重", hours: "07:00-22:30", desc: "福岡明太子重名店，從天神地下街往中洲方向可步行前往。觀光客排隊度高，想吃福岡代表性午餐可以排", tag: "排隊名物", igRecommend: true, lat: 33.5905, lng: 130.4045, mapUrl: "https://www.google.com/maps/search/?api=1&query=元祖博多めんたい重" },
                { name: "稚加榮 福岡店", hours: "11:30-14:00", desc: "大名方向的老牌料亭午餐，想吃質感海鮮/和食可列入。供應狀況可能變動，建議出發前確認午餐與訂位", tag: "料亭午餐", igRecommend: true, lat: 33.5885, lng: 130.3925, mapUrl: "https://www.google.com/maps/search/?api=1&query=稚加榮+福岡店" },
                { name: "LaLaport 美食街", hours: "11:00-21:00", desc: "鋼彈行程的保底午餐。若天神名店排隊太久，直接在 LaLaport 解決最省時間，選擇多、座位也好找", tag: "保底", lat: 33.5665, lng: 130.4283, mapUrl: "https://www.google.com/maps/search/?api=1&query=LaLaport+Fukuoka" },
                { name: "伊都Kingu (草莓)", hours: "10:00-20:00", desc: "飯後甜點，不當正餐。主打福岡「あまおう」草莓，適合吃完午餐後順路補一個甜點", tag: "甜點", lat: 33.5902, lng: 130.3985, mapUrl: "https://www.google.com/maps/search/?api=1&query=伊都きんぐ+天神店" }
            ],
            dinner: [
